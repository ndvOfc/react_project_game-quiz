...
module.exports = {
  ...
  seedDb: async () => {
    ...
    const groupId2 = 2;
    const topicName3 = ['Здесь вопросы', 'Нет вопросов', 'Или повторяются']
    const groupId3 = 3;
...
//2
    ...
    const gri6 = 6
    //7
    const grq7 = ['Рекордсмен по количеству Спасибо All-Time',
      'Продолжите: "Это какая-то..."',
      'Автор фразы: "Это лучшее, что я видела"',
      'Кто говорит: "Так работает JS"',
      'Самый недушный преподаватель по версии голосования прошедшей недели, выигравший с отрывом в миллион голосов'
    ]
    const gra7 = ['Азамат,Бог,Денис,Сергей',
      'жесть,дичь,темнота,звезда',
      'Аня,Лейла,Надя,Даша',
      'все так теперь говорят,Артем,ваш сосед по подъезду,Леша',
      'Артем,Аня,Лена,Леша'
    ]
