...
//2
    ...
    //5
    const grq5 = ['Как звучит официальное название Японии?',
      'Какой город является столицей Японии?',
      'Как зовут действующего императора Японии?',
      'Какой вид спорта является национальным видом спорта в Японии?',
      'Как называется наиболее популярная форма поэзии в Японии?'
    ]
    const gra5 = ['Нихон коку,Окаасан,Ляй Сан,Тэн По',
      'Токио,Пекин,Нагасаки,Моджо',
      'Акихито,Синдзо Абэ,Хирохита,Наруто',
      'Сумо,Тхэквондо,Айкидо,Горные лыжи',
      'Хайку,Танка,Синквейн,Частушки'
    ]
    const grp5 = [100, 200, 300, 400, 500]
    const gri5 = 5
    //6
    const grq6 = ['В каком чине Наполеон начал военную службу?',
      'Блюдо, стойко ассоциирующееся с французами',
      'В каком году сборная Франции по футболу выиграла ЧМ',
      'Столица Франции',
      'Действующий президент(любит звонить президенту России)'
    ]
    const gra6 = ['Младший лейтенант,ефрейтор,прапорщик,генерал',
      'Лягушачьи лапки,лягушачьи жопки,свинячьи хвостики,пельмени',
      '1998,2000, 1994,2010',
      'Париж,Тулуза,Челябинск,Марсель',
      'Макрон,Макарон,Жак Ширак,Доширак'
    ]
